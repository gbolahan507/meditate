...
class Listen_now_chatPage extends StatelessWidget {
  @override
              ...
              children: [
                SpecialButtonFilled(
                  ...
                  color: pink200,
                   ...
                   SizedBox(width: 15),
                    Apptext(text: 'Rohit', color: pink200, fontsize: 30, fontweight: FontWeight.w700,),
                   ...
                   Row(
                     children: [
                       Container(
                         ...
                         child: Apptext(text: 'Hello Rahul', color: pink200, fontsize: 20,)
                       ),
                     ],
                   ),
                     Row(
                     ...
                     children: [
                       Container(
                         decoration: BoxDecoration(color: pink200),
                         padding: EdgeInsets.symmetric(vertical:5, horizontal:10),
